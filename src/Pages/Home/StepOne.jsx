...
function StepOne() {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    ...
    <div>
                    <p className='pt-3' style={{fontSize:'25px',fontWeight:'700',fontFamily:'raleway', color:'tomato'}}>BloomsGirl! <span style={{color:'#0096FF',fontSize:'19px'}}>What Is Our Motto?<a target="_blank" href="https://www.hrw.org/topic/womens-rights"></a></span></p>
